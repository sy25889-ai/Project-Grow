...
![B~SS 등급 탱커 캐릭터 콘셉트](images/tank_lineup.png)

B, A, S, SS 등급 탱커의 외형과 역할 방향을 보여주는 콘셉트 이미지이다.
세부 외형은 추후 실제 3D 캐릭터 제작 과정에서 조정할 수 있다.

#### 인게임 전투 비주얼 콘셉트

![탱커 인게임 전투 비주얼 콘셉트](images/tank_ingame_concept.png)

Project Grow의 고정형 3D 전투 시점과 세계수 지역의 보스 전투 연출 방향을 보여주는 비주얼 참고 이미지이다.

이번 이미지는 최종 게임 에셋이 아니라 캐릭터 및 인게임 연출 방향을 정의하기 위한 콘셉트 및 비주얼 가이드이다.
